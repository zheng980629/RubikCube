...
class Encoder(nn.Module):
    ...
    def forward(self, x, encoder_outs=None, decoder_outs=None):
        ...
        if (encoder_outs is not None) and (decoder_outs is not None):
            # enc1 = F.interpolate(enc1, size=self.csff_enc1(encoder_outs[0]).shape[-2:])
        ...
        if (encoder_outs is not None) and (decoder_outs is not None):
            # enc2 = F.interpolate(enc2, size=self.csff_enc2(encoder_outs[1]).shape[-2:])
        ...
        if (encoder_outs is not None) and (decoder_outs is not None):
            # enc3 = F.interpolate(enc3, size=self.csff_enc3(encoder_outs[2]).shape[-2:])
...
class ORSNet(nn.Module):
    def __init__(self, n_feat, scale_orsnetfeats, kernel_size, reduction, act, bias, scale_unetfeats, num_cab, shiftPixel, gc):
        super(ORSNet, self).__init__()

        self.orb1 = ORB(n_feat + scale_orsnetfeats, kernel_size, reduction, act, bias, num_cab)
        self.orb1_1 = RubikCube_multiply(n_feat + scale_orsnetfeats, n_feat + scale_orsnetfeats, shiftPixel, gc)
        self.orb2 = ORB(n_feat + scale_orsnetfeats, kernel_size, reduction, act, bias, num_cab)
        self.orb2_1 = RubikCube_multiply(n_feat + scale_orsnetfeats, n_feat + scale_orsnetfeats, shiftPixel, gc)
        self.orb3 =ORB(n_feat + scale_orsnetfeats, kernel_size, reduction, act, bias, num_cab)
        self.orb3_1 = RubikCube_multiply(n_feat + scale_orsnetfeats, n_feat + scale_orsnetfeats, shiftPixel, gc)
    ...
    def forward(self, x, encoder_outs, decoder_outs):
        x = self.orb1_1(self.orb1(x))
        x = x + self.conv_enc1(encoder_outs[0]) + self.conv_dec1(decoder_outs[0])

        x = self.orb2_1(self.orb2(x))
        # x = F.interpolate(x, size=self.conv_enc2(self.up_enc1(encoder_outs[1])).shape[-2:])
        x = x + self.conv_enc2(self.up_enc1(encoder_outs[1])) + self.conv_dec2(self.up_dec1(decoder_outs[1]))

        x = self.orb3_1(self.orb3(x))
        # x = F.interpolate(x, size=self.conv_enc3(self.up_enc2(encoder_outs[2])).shape[-2:])
...
class MPRNet_rubikCube(nn.Module):
    ...
    def forward(self, x3_img):
        ...
        x1ltop = self.shallow_feat1_1(self.shallow_feat1(x1ltop_img))
        x1rtop = self.shallow_feat1_1(self.shallow_feat1(x1rtop_img))
        x1lbot = self.shallow_feat1_1(self.shallow_feat1(x1lbot_img))
        x1rbot = self.shallow_feat1_1(self.shallow_feat1(x1rbot_img))
        ...
        ##-------------------------------------------
        ## Compute Shallow Features
        x2top = self.shallow_feat2_1(self.shallow_feat2(x2top_img))
        x2bot = self.shallow_feat2_1(self.shallow_feat2(x2bot_img))
        ...
        ##-------------------------------------------
        ## Compute Shallow Features
        x3 = self.shallow_feat3_1(self.shallow_feat3(x3_img))
        ...
        # stage3_img = F.interpolate(stage3_img, size=x3_img.shape[-2:])
